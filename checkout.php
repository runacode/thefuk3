...
<div class='ktemplate_pageContainer'>
    ...
    <div class="express-checkout-wrap">
        <div><span><?= T('Express Checkout'); ?></span></div>
        <br><?php $ksdk->echoPaypalCheckoutButton(); ?></div>
    ...
    <form id='kform' class='kform kform_kcartCheckout' onsubmit='return false;'>
        <div class='kform_layout2Col kform_layout2Col_L'>
            ...
            <div class='kform_spacer kform_checkbox d-none'>
        ...
        <div class='kform_layout2Col  kform_layout2Col_R'>
            ...
            <div id='kform_paySourceCard'
                 style=" padding-bottom: 0.25em; background: #f5fbf6; padding-top: 10px; margin-bottom: 0">
                <div class='kform_spacer' style="margin-top: 0">
            ...
            <div style="border-bottom: 1px solid #ade0b3; padding-bottom: 10px; background: #f5fbf6; ">
                <button class='kform_submitBtn' id='kformSubmit'><?= T('Complete Order'); ?> <i
                            class="fa fa-arrow-circle-right"></i></button>
            </div>
            <div class="express-checkout-wrap">
                <div><span><?php T('or') ?></span></div>
                <br><img src="resources/images/paypal.png" id="kform_payPalButton2"
                         style="width: 100%; max-width: 260px; cursor: pointer;"></div>
...
<script>
    ...
    $(document).on('click', '#order-summary-toggle-button', function () {
        $('#kcartDetail').toggleClass('d-none');

        if ($('#kcartDetail').hasClass('d-none')) {
            $(this).find('*[class^="fa fa-angle"]').attr('class', 'fa fa-angle-down');
        } else {
            $(this).find('*[class^="fa fa-angle"]').attr('class', 'fa fa-angle-up');
        }

    });

    $(document).on('click', '#kform_payPalButton2', function () {
        $('#kform_payPalButton').click();
    })
</script>
</body>
</html>
